...
SET MYSQLHOSTNAME=REPLACE_MYSQLHOSTNAME
SET MYSQLUSERNAME=REPLACE_MYSQLUSERNAME
SET MYSQLPASSWORD=REPLACE_MYSQLPASSWORD
SET MYSQLDATABASE=REPLACE_MYSQLDATABASE


REM copies all of the table structures into structure.sql
ECHO > 03-structure.sql
REM IF EXISTS 03-structure.sql DEL /Q /F 03-structure.sql
...
ECHO Post installation: Reset usernames and passwords.
...
ECHO Produces the database dump right after installation
