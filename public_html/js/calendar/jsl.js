(function()
{
	window.JSL = {"_getUserArgs": function(arguments)
	{
		var user_args = [];
...
(function()
{
	...
	A.prototype = {"add": function(F, D, E, C)
	{
		function B(H)
		{
...
(function()
{
	...
	_ajax_init.prototype = {"http": false, "format": "text", "callback": false, "handler": false, "error": false, "opt": {}, "_getHTTPObject": function()
	{
		var http = false;
	...
	{
		var opt = {"onSuccess": false, "onError": false, "format": "text", "method": "GET", "update": "", "loading_indicator": "", "loading_text": ""};
		for(var key in opt)
		{
			if(user_options[key])
			{
