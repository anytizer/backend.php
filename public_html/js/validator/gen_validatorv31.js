...
function Validator(frmname)
{
	...
	if(!this.formobj)
	{
		custom_alert("Error: couldnot get Form object " + frmname);
		return;
	}
...
function add_validation(itemname, descriptor, errstr)
{
	...
	if(!this.formobj)
	{
		custom_alert("Error: The form object is not set properly");
		return;
	}//if
	...
	if(!itemobj)
	{
		custom_alert("Error: Couldnot get the input object named: " + itemname);
		return;
	}
