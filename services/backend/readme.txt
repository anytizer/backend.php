...
sqls: Sets of SQLs to register pages. Be careful with with the sub-domain ID.
...
js: Holds sub-domain specific js files (name should be different as that in parent js directory)
