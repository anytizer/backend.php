...
/**
 * Lists entities in permissions
 */

# When a user will cancel add/edit forms, we will try to come back here
\common\url::remember();

# Begin the paginator along with: permissions
...
# Pagination helper
$pagination->set_total($permissions->total_entries());
$smarty->assignByRef('pagination', $pagination);

# Assign to Smarty: Lists
$smarty->assignByRef('permissionss', $entries);
