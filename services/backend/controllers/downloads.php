...
# Created on: 2010-12-14 00:49:39 606
...
# Begin the paginator along with: downloads
...
# Pagination helper
$pagination->set_total($downloads->total_entries());
$smarty->assignByRef('pagination', $pagination);

# Assign to Smarty: Lists
$smarty->assignByRef('distributions', $entries);
