...
{/if}
<form autocomplete="off" id="superfish-list-form" name="superfish-list-form" method="post" action="superfish-blockaction.php">
	<table class="data" id="data-table">
		...
		<tr class="{cycle values='A,B'}">
			...
			<td><a class="delete"
			       href="superfish-delete.php?id={$superfishs[l].menu_id}&amp;code={$superfishs[l].code}">{icon name='delete'}</a>
			</td>
			<!--{* Column Data *}-->
			...
			<td class="nowrap">
				<a class="edit"
				   href="superfish-edit.php?id={$superfishs[l].menu_id}&amp;code={$superfishs[l].code}">{icon name='edit'}</a>
			</td>
		</tr>
		{sectionelse}
		<tr class="error">
