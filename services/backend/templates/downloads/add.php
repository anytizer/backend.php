...
<form autocomplete="off" id="downloads-add-form" name="downloads-add-form" method="post" action="downloads-add.php">
	<table class="data">
...
{js src='validators/downloads/add.js' validator=true}
