...
<table class="data" id="data-table">
	...
	<tr class="{cycle values='A,B'}">
		...
		<td><a class="delete"
		       href="downloads-delete.php?id={$downloadss[l].distribution_id}&amp;code={$downloadss[l].code}">{icon name='delete'}</a>
		</td>
		<td>
		...
		<td class="nowrap">
			<a class="edit"
			   href="downloads-edit.php?id={$downloadss[l].distribution_id}&amp;code={$downloadss[l].code}">{icon name='edit'}</a>
		</td>
	</tr>
	{sectionelse}
	<tr class="error">
