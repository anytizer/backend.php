    ...
    <table class="data edit">
        ...
        <tr class="{cycle values='A,B'}">
            ...
            <td><select name="entity[subdomain_id]">
                    ...
                    <!-- system:services, system:subdomains_available, system:subdomains_available:visible -->
                    {html_options options='system:services'|dropdown}
...
<p>You MUST type the entity name correctly, and
    <strong>reverse type</strong> it for security reasons that - you are doing it purposefully. Upon successful
    completion, it will create some files and an .sql file to fire on the server. This file will register all of the
    CRUDed files. Dependencies of subdomain_id is solved automatically.
</p>
