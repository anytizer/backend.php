...
<form id="licenses-list-form" name="licenses-list-form" method="post" action="licenses-blockaction.php">
	<table class="data" id="data-table">
		...
		<tr class="{cycle values='A,B'}">
			...
			<td><a class="delete"
			       href="licenses-delete.php?id={$licensess[l].license_id}&amp;code={$licensess[l].code}">{icon name='delete'}</a>
			</td>
			<td>
			...
			<td class="nowrap">
				<a class="edit"
				   href="licenses-edit.php?id={$licensess[l].license_id}&amp;code={$licensess[l].code}">{icon name='edit'}</a>
			</td>
		</tr>
		{sectionelse}
		<tr class="error">
