...
<form id="permissions-list-form" name="permissions-list-form" method="post" action="permissions-blockaction.php">
    <table class="data" id="data-table">
        ...
        <tr class="{cycle values='A,B'}">
            ...
            <td><a class="delete"
                   href="permissions-delete.php?id={$permissionss[l].crud_id}&amp;code={$permissionss[l].code}">{icon
                    name='delete'}</a>
            </td>
            ...
            <td class="nowrap">
                ...
                *}
                <a class="edit"
                   href="permissions-edit.php?id={$permissionss[l].crud_id}&amp;code={$permissionss[l].code}">{icon
                    name='edit'}</a>
                <a class="permissions"
                   href="permissions-matrix.php?id={$permissionss[l].crud_id}&amp;code={$permissionss[l].code}">{icon
                    name='permissions'}</a>
            </td>
        </tr>
        {sectionelse}
