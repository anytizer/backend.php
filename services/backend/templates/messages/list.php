...
<form id="messages-list-form" name="messages-list-form" method="post" action="messages-blockaction.php">
    <table class="data" id="data-table">
        ...
        <tr class="{cycle values='A,B'}">
            ...
            <td><a class="delete"
                   href="messages-delete.php?id={$messagess[l].message_id}&amp;code={$messagess[l].code}">{icon
                    name='delete'}</a>
            </td>
            ...
            <td class="nowrap">
                <a class="edit"
                   href="messages-edit.php?id={$messagess[l].message_id}&amp;code={$messagess[l].code}">{icon
                    name='edit'}</a>
            </td>
        </tr>
        {sectionelse}
