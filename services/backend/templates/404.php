...
<div class="wrapper" style="padding:20px;">
	...
	<div
		style="padding:30px; border:1px solid #FF6600; background-color:#FFFF99; margin-bottom:10px;">{if $message}{$message}{else}Sorry, the page you are trying to view is not here.{/if}
	</div>
	...
	<p> Links from other sites can sometimes be outdated or misspelled. We'd like to fix that problem too, consider dropping us an
	...
	<p> You may have typed the address (URL) incorrectly. Check to make sure you've got the exact right spelling, capitalization, etc.</p>
