	...
	<table class="contact_form">
		...
		<tr>
			<td><p class="r">Message, Reasons, Queries:</p>
				...
				<p>We hide the email addreses for first time contacts. So, google, yahoo and MSN contacts are NOT published. When you contact us once, we will give them to you.</p>
			</td>
