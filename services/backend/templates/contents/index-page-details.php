...
<p><strong>For Professional Support and customization</strong>: This application is a framework only - and is very good for custom projects (that needed to be built from the scratch). So, you may think of supporting us by hiring there.
</p>
<p>Core Part of our framework is always in open source, while your project's main file will be never exposed out. You are working with trusted staff, and for reliable technical support.</p>
...
<p>Now, you can write your own module, without affecting the core system we develop. Hence, it can increase your creativity.
	<a href="http://bimal.org.np/">See more in google codes</a>.</p>
<h3><a></a>Backend / Frontend</h3>
<p>We have almost lost the concepts of backend for our projects, and this framework supports making a frondend look like its backend. Here is a code sample on how to list out the database entities, like menus:</p>
...
<p>
	<strong>Forget the coding</strong>, you do not have to remember or rewrite it anymore. This framework allows you to bring the security, auto generated codes, and error/success messages.
</p>
<h3><a></a>We use Object Oriented MVC Pattern</h3>
<p>For an operation there are three different files: a model (the heart), a controller that interacts with user commands, and the view (Based on Smarty) to show up the results. In total there are 12 different files for add/delete actions, and all of them are automated, to speed up your work. Take an example:</p>
