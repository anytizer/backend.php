...
<form autocomplete="off" id="subdomains-list-form" name="subdomains-list-form" method="post" action="subdomains-blockaction.php">
	<table class="data" id="data-table">
		...
		<tr class="{cycle values='A,B'}">
			...
			<td><a class="delete"
			       href="subdomains-delete.php?id={$subdomainss[l].subdomain_id}&amp;code={$subdomainss[l].code}">{icon name='delete'}</a>
			</td>
			<td>
			...
			<td nowrap="nowrap">
				<a class="edit"
				   href="subdomains-sort.php?id={$subdomainss[l].subdomain_id}&amp;direction=up">{icon name='up'}</a> <a
					class="edit"
					href="subdomains-sort.php?id={$subdomainss[l].subdomain_id}&amp;direction=down">{icon name='down'}</a>
				<a class="edit"
				   href="subdomains-edit.php?id={$subdomainss[l].subdomain_id}&amp;code={$subdomainss[l].code}">{icon name='edit'}</a>
				<a class="add"
				   href="subdomains-install.php?id={$subdomainss[l].subdomain_id}&code={$subdomainss[l].code}">{icon name='add' title='Install'}</a>
				<a class="alias"
