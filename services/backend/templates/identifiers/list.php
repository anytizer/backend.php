...
<form id="identifiers-list-form" name="identifiers-list-form" method="post" action="identifiers-blockaction.php">
	<table class="data" id="data-table">
		...
		<tr class="{cycle values='A,B'}">
			...
			<td><a class="delete"
			       href="identifiers-delete.php?id={$identifierss[l].identifier_id}&amp;code={$identifierss[l].code}">{icon name='delete'}</a>
			</td>
			<!--{* Column Data *}-->
			...
			<td class="nowrap">
				<a class="edit"
				   href="identifiers-edit.php?id={$identifierss[l].identifier_id}&amp;code={$identifierss[l].code}">{icon name='edit'}</a>
			</td>
		</tr>
		{sectionelse}
		<tr class="error">
