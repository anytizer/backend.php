...
public $pixels = 0;
    ...
    private $resize_width_max = 64;
        private $resize_height_max = 64; # at least a color should cover this %age to be considered
    private $threshold_coverage = 0; # How many colors to draw from the top ranks
private $maximum_colors = 7;
    /**
    ...
    private $colors = null; # Number of pixels processed
