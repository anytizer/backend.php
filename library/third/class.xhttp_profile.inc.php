 ...
 * @link http://sudocode.net/sources/includes/class-xhttp-php/plugin-xhttp-profile-php/
 * @todo Recover the orignal links and website for XHTTP, also seen at - https://github.com/opf-attic/opf_lds3/tree/master/admin/class-xhttp-php
 */
class xhttp_profile
{
	...
	public static function getRequestData($profile)
	{
	...
	public function updateStatus($status = '')
	{
		...
		$response = $this->fetch('http://api.twitter.com/1/statuses/update.json', $data);
