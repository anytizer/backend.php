...
<div class="information">
    <ul class="links admin-editor btm-action">
        <li class="list public">
            <a href="__SINGULAR__.php?id={$__ENTITY__.__PK_NAME__}&amp;code={$__ENTITY__.code}" class="view">As
                Public</a>
        </li>
        <li class="list edit">
        ...
        <li class="list delete">
            <a href="__ENTITY__-delete.php?id={$__ENTITY__.__PK_NAME__}&amp;code={$__ENTITY__.code}"
               onclick="return window.confirm('Are you sure to delete this?');" class="list">Delete</a>
        </li>
    </ul>
</div>
<div class="clear"></div>
