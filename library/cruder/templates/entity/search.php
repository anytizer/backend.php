...
<div class="search-form">
    <form autocomplete="off" method="post" action="__ENTITY__-search.php" name="__ENTITY__-livesearch"
...
<!-- paginator begins -->
<div class="paginator">
    Jump to page:    <!-- wrap with <ul>...</ul> tags when using ulli=true parameter. -->    <!-- <ul> -->    {paginate
    separator=' ' ulli=false source=$pagination}    <!-- </ul> -->
</div>
<!-- paginator ends -->
{/if}
            ...
            <td class="nowrap">
                <a class="edit"
                   href="__ENTITY__-sort.php?id={$__ENTITY__s[l].__PK_NAME__}&amp;direction=up">{icon name='up'}</a> <a
                    class="edit"
                    href="__ENTITY__-sort.php?id={$__ENTITY__s[l].__PK_NAME__}&amp;direction=down">{icon
                    name='down'}</a>
                <a class="edit"
                   href="__ENTITY__-edit.php?id={$__ENTITY__s[l].__PK_NAME__}&amp;code={$__ENTITY__s[l].code}">{icon
                    name='edit'}</a>
                <a class="delete"
                   href="__ENTITY__-delete.php?id={$__ENTITY__s[l].__PK_NAME__}&amp;code={$__ENTITY__s[l].code}">{icon
                    name='delete'}</a>
            </td>
        </tr>
        {sectionelse}
