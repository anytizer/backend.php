...
<div class="form-wrap">
    <form id="__ENTITY__-list-form" name="__ENTITY__-list-form" method="post" action="__ENTITY__-blockaction.php">
        <table class="data" id="data-table">
            ...
            <thead>
            <tr class="thead">
                <th class="checkboxes"><input type="checkbox" id="__ENTITY__-checkall" name="checkallentities"
            ...
            <tr class="{cycle values='A,B'}">
                <td class="checkboxes"><input type="checkbox" name="__ENTITY__[]"
                                              value="{$__ENTITY__s[l].__PK_NAME__}"/></td>
                <td class="r">{$smarty.section.l.index_next+$pagination->beginning_entry()}.</td>
                <td>
                    <a class="ajax"
                       href="__ENTITY__-flag.php?ajax=true&amp;flag=is_approved&amp;id={$__ENTITY__s[l].__PK_NAME__}&amp;code={$__ENTITY__s[l].code}">{$__ENTITY__s[l].is_approved|yn}</a>
                </td>
                <td>
